...
public class PerimeterAreaOfRetangle extends AsyncTask<Void, Void, Void> {
    Context context;
    String width, height, result;
    TextView tv_result;
    ProgressDialog progressDialog;

    String link = RetangleActivity.SERVER_NAME;

    public PerimeterAreaOfRetangle(Context context, String width, String height, TextView tv_result) {
